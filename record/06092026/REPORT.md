...
> Generated 2026-09-06T05:52:15.443Z - Node v24.18.0 - win32 x64 - AMD Ryzen 5 5600 6-Core Processor               x12 - 16310 MB RAM
...
|---|---:|---:|---|---|
| Cold build avg | 349 ms | 5.94 s | [Chocola] Chocola | 17.02x |
| Warm build avg | 383 ms | 6.04 s | [Chocola] Chocola | 15.77x |
| Cold build median | 349 ms | 5.94 s | [Chocola] Chocola | 17.02x |
| Dev startup | 388 ms | 1.87 s | [Chocola] Chocola | 4.82x |
...
- **Cold build:** avg 349 ms - median 349 ms - min 349 ms - max 349 ms - runs [349 ms]
- **Warm build:** avg 383 ms - median 383 ms - min 383 ms - max 383 ms - runs [383 ms]
- **Build output (`dist`):** 214.34 KB (219,481 B) - 10 files - exists
  ...
  - Largest: static\img\banner.jpg (111.35 KB (114,025 B)), sc-47gn4b.css (36.45 KB (37,329 B)), static\img\footer_img.svg (21.01 KB (21,512 B)), index.html (16.55 KB (16,944 B)), run-o263rz.js (8.62 KB (8,825 B))
- **Dev startup (port 3000):** 388 ms (log)
...
- **Cold build:** avg 5.94 s - median 5.94 s - min 5.94 s - max 5.94 s - runs [5.94 s]
- **Warm build:** avg 6.04 s - median 6.04 s - min 6.04 s - max 6.04 s - runs [6.04 s]
- **Build output (`build`):** 260.17 KB (266,413 B) - 21 files - exists
  ...
  - Largest: img\banner.jpg (111.35 KB (114,025 B)), _app\immutable\chunks\Crwxnk5c.js (26.76 KB (27,407 B)), _app\immutable\entry\start.Biw2glAo.js (22.35 KB (22,884 B)), img\footer_img.svg (21.01 KB (21,512 B)), _app\immutable\nodes\2.CIM2g1Wm.js (17.91 KB (18,336 B))
- **Dev startup (port 5174):** 1.87 s (http)
- **Cache:** .svelte-kit: 663.84 KB (679,768 B) (63 files)
